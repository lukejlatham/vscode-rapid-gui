...
import {
  BackgroundProps,
  GridCellProps,
  TooltipConfigGridCell as TooltipConfig,
} from "../../../types";
import {
  Slider,
  SliderOnChangeData,
...
export const GridCellSettings: React.FC = () => {
  ...
  const tooltips: TooltipConfig[] = [
    {
      label: "Direction",
      content: "Set the direction of the grid cell.",
      propKey: "flexDirection",
      type: "direction",
    },
    {
      label: "Justify Content",
      content: "Set how the contents of the cell should be justified.",
      propKey: "justifyContent",
      type: "justifyContent",
    },
    {
      label: "Align Items",
      content: "Set how the contents of the cell should be aligned.",
      propKey: "alignItems",
      type: "alignItems",
    },
    {
      label: "Gap",
      content: "Adjust the gap between components within the cell.",
      propKey: "gap",
      type: "slider",
    },
  ];
          ...
          {tooltip.type === "slider" ? (
            ...
            <RadioGroup
              ...
              onChange={(e: React.FormEvent<HTMLDivElement>, data: { value: string }) => {
                actions.setProp((props: GridCellProps) => {
                  (props[tooltip.propKey] as "flex-start" | "center" | "flex-end") = data.value as
                    | "flex-start"
                    | "center"
                    | "flex-end";
                }, 1000);
