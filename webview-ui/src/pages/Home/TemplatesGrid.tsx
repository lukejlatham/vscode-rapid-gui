...
const templates = [
  {
    ...
    icon: <DesktopRegular />,
    data: { id: uuidv4(), name: "Website", content: Website },
  },
  {
    name: "Login Page",
    icon: <PersonPasskeyRegular />,
    data: { id: uuidv4(), name: "Login Page", content: Login },
  },
  {
    name: "Video Game Settings",
    icon: <GamesRegular />,
    data: { id: uuidv4(), name: "Video Game Settings", content: VideoGameSettings },
  },
  {
    name: "Feedback Form",
    icon: <FormRegular />,
    data: { id: uuidv4(), name: "Feedback Form", content: FeedbackForm },
  },
];
