        ...
        <Dialog modalType='alert' open={isOpen} onOpenChange={(event, data) => onClose()}>
            <DialogSurface>
                <DialogBody>
                    ...
                    <DialogActions fluid>
                        <Button icon={<ArrowLeftFilled/>} onClick={onClose} size='large' appearance="secondary">Cancel</Button>
                        <Button onClick={handleClick} size='large' appearance="primary" icon={<ArrowResetFilled/>}>Restart</Button>
                    </DialogActions>
                </DialogBody>
            </DialogSurface>
        </Dialog>
