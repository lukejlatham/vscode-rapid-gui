...
export class FileGenerator {
  ...
  private createReadme() {
    try {
      ...
      console.warn("Failed to create README.md file:", error.message);
      const basicReadme = `# ${this.projectName}\n\nThis is a WinUI 3 project generated by WinUI 3 Project Template Generator`;
      this.createFile("README.md", basicReadme);
    }
  }
}
