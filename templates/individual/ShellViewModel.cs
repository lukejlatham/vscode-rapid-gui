...
using TemplateProject.Contracts.Services;
...
public partial class ShellViewModel : ObservableRecipient
{
    ...
    public ICommand MenuViewsBlank1Command
    {
        get;
    }
    ...
    public ShellViewModel(INavigationService navigationService)
    {
        ...
        MenuViewsBlank1Command = new RelayCommand(OnMenuViewsBlank1);
    ...
    private void OnMenuViewsBlank1() => NavigationService.NavigateTo(typeof(Blank1ViewModel).FullName!);
